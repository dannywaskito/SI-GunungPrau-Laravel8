				...
				<div class="row">
					...
					<div class="col-sm-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" name="posisi" value="{{old('posisi')}}" id="posisi" readonly>
							<div class="text-danger">
								@error('posisi')
								{{ $message }}
								@enderror
					...
					<div class="col-sm-12">
						...
						<textarea name="ket" rows="5" class="form-control">{{old('ket')}}</textarea>
						<div class="text-danger">
							@error('ket')
							{{ $message }}
							@enderror
					...
					<div class="col-sm-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" name="jml_anggota" value="{{old('jml_anggota')}}">
							<div class="text-danger">
								@error('jml_anggota')
								{{ $message }}
								@enderror
					...
					<div class="col-sm-12">
						...
						<textarea name="alamat" rows="7" class="form-control">{{old('alamat')}}</textarea>
						<div class="text-danger">
							@error('alamat')
							{{ $message }}
							@enderror
...
<script>
	...
	var curLocation = [-6.399291, 106.875539];
